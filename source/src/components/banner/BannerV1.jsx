                                ...
                                <div className="col-xl-6 col-lg-6">
                                    <div className="information">
                                        ...
                                        <Animate className="animate__animated animate__fadeInUp" delay="900ms" duration="400ms">
                                            <p>
                                                We help creators, entrepreneurs, and businesses amplify their message through powerful video content, personalized strategies, and streamlined social media distribution
